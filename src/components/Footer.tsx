        ...
        <div className="site-footer__grid">
          ...
          <div className="site-footer__col site-footer__col--brand">
            ...
            <p className="site-footer__mission">
              HSM Aries is the student space-robotics team of Hochschule Schmalkalden, based at the Chair of Drive, Automation, and Robotics Technologies. We design, build and field planetary rovers for the European Rover Challenge.
            </p>
          ...
          <div className="site-footer__col site-footer__col--partner">
            ...
            <p className="site-footer__subtext">
              ...
              <br />
              <Link href="/contact">Write to the team</Link>
            </p>
          </div>
          ...
          <div className="site-footer__col">
            ...
            <nav aria-label="Site pages" className="site-footer__nav">
          ...
          <div className="site-footer__col">
            ...
            <nav aria-label="Get involved" className="site-footer__nav">
              <Link href="/join">Join the crew</Link>
              <Link href="/partner">Partner with Aries</Link>
            ...
            <div className="site-footer__social-links">
              ...
              <a
                aria-label="LEAP-One on YouTube"
                className="site-footer__social-btn"
                href="https://www.youtube.com/watch?v=FoB0QA2CAig"
                rel="noreferrer"
                target="_blank"
                title="LEAP-One on YouTube"
              >
                <svg fill="currentColor" height="16" viewBox="0 0 24 24" width="16">
              ...
              <a
                aria-label="LEAP-One source code on GitHub"
                className="site-footer__social-btn"
                href="https://github.com/kiranvenom1209/LeapOne_rover"
                rel="noreferrer"
                target="_blank"
                title="LEAP-One source code on GitHub"
              >
                <svg fill="currentColor" height="16" viewBox="0 0 24 24" width="16">

export type NewsMedia = {
  ...
  credit?: string
  mimeType?: string
  /** Still frame shown before a video asset plays. */
  poster?: string
  url: string
}

/** One line of a competition scoreboard. `max: 0` marks a penalty or bonus line with no track. */
export type NewsScoreboardRow = {
  label: string
  max: number
  points: number
  rank?: string
...
export type NewsStory = {
  ...
  mediaDeck?: NewsMedia[]
  publishedAt: string
  /** Static-layer only: rendered as a table under the lede when present. */
  scoreboard?: NewsScoreboardRow[]
  /** Optional search/share description; falls back to `excerpt`. */
...
const sourceNews: NewsStory[] = [
  {
    ...
    "scoreboard": [
      { "label": "Documentation", "points": 364.25, "max": 400, "rank": "4th of 25" },
      { "label": "Navigation droning", "points": 265, "max": 300, "rank": "6th of 25" },
      { "label": "Presentation", "points": 229, "max": 300 },
      { "label": "AstroBio", "points": 215, "max": 300 },
      { "label": "Surface & deep sampling", "points": 197, "max": 440 },
      { "label": "Exploration", "points": 123, "max": 340 },
  ...
  },
  {
    ...
    "seoDescription": "ERC 2026 qualification: HSM Aries.space placed first of 124 teams worldwide with 239.75 of 250 points for the LEAP-One mission, built on its Preliminary Design Review and qualification video.",
    "excerpt": "HSM Aries.space ranked first among 124 international teams in the ERC 2026 qualification stage, earning 239.75 of 250 points for the LEAP-One mission on the strength of its Preliminary Design Review and qualification video.",
    "publishedAt": "2026-06-28T15:34:00.000Z",
    "category": "Competition",
    "image": "/media/dsc01524-scaled.jpg",
    "imageAlt": "LEAP-One on a leaf-covered field trial course ahead of the ERC 2026 qualification.",
    "mediaDeck": [
      { "alt": "ERC 2026 qualification badge: rank 1, 239.75 points.", "url": "/media/hsm-png.png", "caption": "ERC 2026 qualification result: rank 1, 239.75 points." },
    ...
    "body": [
      ...
      "Earning 1st place out of 124 teams proves that our mission architecture sets a new standard for the ERC.",
  ...
  },
  {
    ...
    "excerpt": "The team has released its official 10-minute ERC 2026 qualification video, presenting the core engineering and mission architecture behind the LEAP-One entry.",
    "publishedAt": "2026-05-31T15:31:00.000Z",
    "category": "Competition",
    "image": "/media/dsc01546-scaled.jpg",
    "imageAlt": "LEAP-One on the field trial course shown in the ERC 2026 qualification video.",
  ...
  },
  {
    ...
    "body": [
      ...
      "A major highlight of the evening was the opportunity to present our engineering directly to state leadership.",
      ...
      "Furthermore, the event served as an exceptional platform for collaboration and knowledge exchange."
    ]
  },
  {
  ...
  },
  {
    ...
    "excerpt": "LEAP-One now carries an ASUS ROG NUC 15 with an NVIDIA GeForce RTX 5080 as its central computer, giving the rover the onboard throughput for 3D mapping, target identification and autonomous path planning.",
  ...
  },
  {
    ...
    "excerpt": "The Drone Department took AQUILA from the lab to the field for manual flight trials, evaluating stability and pilot response in real wind. Semi-autonomous flight modes are next.",
  ...
  },
  {
    ...
    "excerpt": "Field mobility trials on gravel, sand, inclines and mud validated the LEAP-One chassis for ERC 2026 and produced the empirical data for the team’s ICARM 2026 paper, with zero mechanical failures.",
  ...
  },
  {
    ...
    "excerpt": "The Drill Department completed a series of subsurface sampling tests in regolith simulants, extracting ten core samples and gathering the data for the team’s ICARM 2026 publication.",
  ...
  },
  {
    ...
    "excerpt": "The Drone Department has completed assembly of its latest flight unit, moving AQUILA from CAD and prototyping to a flight-ready airframe. Static thrust tests are next.",
  ...
  },
  {
    ...
    "excerpt": "A manual joystick field test took the rover across gravel, paved road, uphill sections and mud. The drivetrain, chassis and control link held up with no issues observed.",
    ...
    "featuredVideo": {
      ...
      "mimeType": "video/mp4",
      "poster": "/media/c0576-poster.webp",
      "url": "/media/c0576-1080p.mp4"
    },
    "body": [
  ...
  },
  {
    ...
    "excerpt": "A delegation from the LEAP-One team attended Space Tech Expo Bremen 2025 to benchmark the rover against industry standards and open partnership conversations across the aerospace sector.",
    ...
    "body": [
      ...
      "Throughout the exhibition, our team was highly active, engaging with representatives from global aerospace giants and specialized startups.",
  ...
  },
  {
    ...
    "excerpt": "Thuringia’s Minister of Science visited the robotics laboratory at Hochschule Schmalkalden, saw the LEAP-One rover and took the controls for a test drive.",
    ...
    "body": [
      ...
      "The highlight of the minister's tour was a visit to the robotics laboratory. Guided by Prof. Frank Schrödel and the HSM Aries.space team, Minister Tischner was introduced to our current flagship project, the LEAP-One Mars Rover model, which features a sophisticated integrated manipulator system.",
  ...
  },
  {
    ...
    "excerpt": "The team tested the CAN adapter with six ODrives over ROS commands, achieving full calibration and coordinated motion on all six wheels for the first time.",
  ...
  },
  {
    ...
    "excerpt": "The team has submitted its first paper to ICRA 2026, taking the LEAP-One rover concept to an international robotics conference.",
    "publishedAt": "2025-09-14T16:06:02.000Z",
    "category": "Research",
    "image": "/media/dsc01541-scaled.jpg",
    "imageAlt": "LEAP-One on a wooded field trial course.",
    "body": [
  ...
  },
  {
    ...
    "excerpt": "After a competitive selection process, HSM Aries welcomed 10 new members to the rover team. Carefully shortlisted from strong applicants, these student engineers bring mechanical, electrical and software skills, fresh perspectives, and a 30-day action focus to speed the LEAP-One project from bench to field.",
    ...
    "body": [
      ...
      "Following this, shortlisted candidates were invited for interviews designed to evaluate their technical knowledge, problem-solving skills, and commitment. After multiple rounds of careful review and discussion, the team finalized the outstanding individuals who will now be part of our journey.",
  ...
  },
  {
    ...
    "excerpt": "Development of the Aries.space website is underway. The new digital hub will showcase HSM Aries projects (including the LEAP Series), publish mission updates, and host resources for students and collaborators. Expect behind-the-scenes content, progress reports, and a user-friendly launch that brings our student-driven space work into one public home.",

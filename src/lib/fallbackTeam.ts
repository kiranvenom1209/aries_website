...
// Canonical department labels (display only — discipline values and slugs stay as they are).
const labelMap: Record<string, string> = {
  leadership: 'Team Leadership',
  mechanical: 'Mechanical & Drivetrain',
  electrical: 'Electrical & Power Systems',
  software: 'Software & Autonomy',
  communication: 'Communications & RF',
  'drill-manipulator': 'Drill & Manipulator',
  astroflight: 'Astroflight (AQUILA UAV)',
...
export const fallbackTeam: TeamMember[] = [
  ...
  },
  {
    ...
    disciplineLabel: 'Mechanical & Drivetrain',
  ...
  },
  {
    ...
    disciplineLabel: 'Communications & RF',
